...
public class MyCaptureActivity extends Activity implements Callback , View.OnClickListener{
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case PARSE_BARCODE_FAIL:
				Toast.makeText(MyCaptureActivity.this, (String)msg.obj, Toast.LENGTH_LONG).show();
				break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode == RESULT_OK){
			...
			case REQUEST_CODE:
				...
				mProgress = new ProgressDialog(MyCaptureActivity.this);
	...
	public Result scanningImage(String path) {
		...
		hints.put(DecodeHintType.CHARACTER_SET, "UTF8"); //设置条码内容的编码
